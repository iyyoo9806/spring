...
function modify(){
	...
	if(!confirm("수정페이지로 가시겠습니까?")){
		return false;
	}
	
	location.href="/modify?idx=${read.idx}"
}
...
function del(){
	...
	location.href="/delete?idx=${read.idx}"
}
					...
					<div class="panel-body">
						<form class="form-horizontal" method="post" action="modifying">
							...
							<div class="panel-footer">
								<button type="button" class="btn btn-default" onclick="return modify();">수정</button>
								<button type="button" class="btn btn-default" onclick="return del();">삭제</button>
